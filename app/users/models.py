...
from app.utils.relations import closest_common_ancestor, describe_relative
...
class Person(BaseModel):
    ...
    maiden_name = models.CharField(blank=True, max_length=30, help_text='Maiden name', null=True)
...
class SurnameVariant(BaseModel):
