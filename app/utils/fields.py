...
class UncertainDate(object):
    """An uncertain date must specify at least a year but doesn't have to specify the month or day."""
...
class UncertainDateField(models.Field):
    """Stores a possibly incomplete date as a (partial) ISO format date (i.e. YYYY-MM-DD, YYYY-MM or YYYY)."""
